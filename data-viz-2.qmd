...
1.  Read the documentation for [`scale_x_continuous()`](https://ggplot2.tidyverse.org/reference/scale_continuous.html). How can you change the name of the axis? What happens if we manually specify the same scale twice (try adding different names)? Why?

2.  How can you change the position of the axes?
