...
# define dataframe
df.rect <- data.frame(
  xmin = c(-Inf, divisions),# makes the rectangles cover the whole area
  xmax = c(divisions, Inf), # makes the rectangles cover the whole area
  ymin = -Inf, # makes the rectangles cover the whole area
  ymax = Inf, # makes the rectangles cover the whole area
  cyl =  c(4, 6, 8)
)
# plotting data
ggplot(mpg) +
