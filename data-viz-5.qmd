...
All themes are set from theme grey.
...
![](images/clipboard-1175428816.png)
...
+-----------------------+----------------------+-------------------------------------------------------------------------------------------------------------------------------------+
| plot.title\           | `element_rect()`     | Plot title, subtitle, caption and tag. Elements subtitle, caption and tag inherit from title by default, but can be set separately. |
| plot.subtitle\        |                      |                                                                                                                                     |
| plot.caption\         |                      |                                                                                                                                     |
| plot.tag              |                      |                                                                                                                                     |
+-----------------------+----------------------+-------------------------------------------------------------------------------------------------------------------------------------+
| plot.title.position\  | character            | Alignment of title (affects subtitle too) and caption (“panel” and “plot”, which align with and without margins respectively).      |
...
+-----------------------+----------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| legend.spacing\       | `unit()`             | Spacing between legends.                                                                                                                                               |
| legend.spacing.x\     |                      |                                                                                                                                                                        |
| legend.spacing.y      |                      |                                                                                                                                                                        |
+-----------------------+----------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| legend.key            | `element_rect()`     | Background of legend keys.                                                                                                                                             |
+-----------------------+----------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| legend.key.size\      | `unit()`             | Legend key size. Height and width inherit from size unless specified separately.                                                                                       |
| legend.key.height\    |                      |                                                                                                                                                                        |
| legend.key.width      |                      |                                                                                                                                                                        |
+-----------------------+----------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+---------------------+------------------+-------------------------------------------------------------------------------------------------------------------+
| panel.grid\         | `element_line()` | Grid lines. Major and minor grid lines, as well as individual ones for axis x and y, can be specified separately. |
| panel.grid.major\   |                  |                                                                                                                   |
| panel.grid.major.x\ |                  |                                                                                                                   |
| panel.grid.major.y\ |                  |                                                                                                                   |
| panel.grid.minor\   |                  |                                                                                                                   |
...
| Element                | Setter           | Description                                                             |
+:=======================+:=================+:========================================================================+
| panel.spacing\         | `unit()`         | Spacing between facets.                                                 |
| panel.spacing.x\       |                  |                                                                         |
| panel.spacing.y        |                  |                                                                         |
+------------------------+------------------+-------------------------------------------------------------------------+
...
| strip.text.y           |                  |                                                                         |
+------------------------+------------------+-------------------------------------------------------------------------+
| strip.switch.pad.grid\ | `unit()`         | Space between facet labels and axes when strips are switched.           |
